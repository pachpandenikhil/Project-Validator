...
function onload(){
	var t="<%=session.getAttribute("flag")%>";
if(t=="yes")
	{
	...
	{
	var y="<%=session.getAttribute("temp")%>";
	...
	document.getElementById("synopsis").value=" ";
		...
		{
		alert("available!!");
		document.getElementById("synopsis").value='<%=session.getAttribute("temp")%>';
...
function hideAll()
{
	...
	hideControl(gr4);document.getElementById("g4").value ="";
...
<form name="minipro" action="controller3.jsp">
<table cellspacing="0" cellpadding="0" width="950px" align="center">
 ...
 <tr>
  ...
  <td>
   <select name="domain">
 	 <option value="computorGraphics">Computer Graphics</option>
 ...
 <tr>
  ...
  <td align="left">
   <select name="year">
 	 <option value="fe">F.E. &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</option>
...
<tr>
  <td align="right" style="color: white;" > No.of Members : </td>
  <td > 
...
<table cellpadding="3">
<tr>
<td align="right" style="color: white;"> Synopsis : <sup style="font-family: inherit;color: red"> * </sup> </td>
<td></td>
<td> <textarea rows="5" cols="45" name="synopsis" id="synopsis"></textarea></td>
